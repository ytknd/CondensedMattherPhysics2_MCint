...
int main () {
    ...
    fprintf(gp, "set output \"mc_integral_3d_sphere.png\"\n");
    fprintf(gp, "set parametric\n");
    fprintf(gp, "set hidden3d\n");
    fprintf(gp, "set view 45\n");
    ...
    fprintf(gp, "splot [0:0.5*pi] cos(u)*cos(v),sin(u)*cos(v),sin(v) lc rgb \"red\", '-' with points pt 0 lc rgb \"orange\"\n");
